...
ID_VRAY_SCENE_HOOK = 1028268
ID_VRAY_VFB_HOOK=1055633
ID_VRAY_RENDER_ELEMENTS_SCENE_HOOK=1054363

VRAY_RENDER_ELEMENT_BASE=160000

VRAY_RENDER_ELEMENT_BASE_COMMON=160001

VRAY_RENDER_ELEMENT_CREATE_NODE_TYPE=160010
VRAY_RENDER_ELEMENT_ENABLED=160011
VRAY_RENDER_ELEMENT_FILTER_PARAMETER_ID=160021
VRAY_RENDER_ELEMENT_DENOISE_PARAMETER_ID=160031
...
VRAY_RENDER_ELEMENT_IDS = [
	ID_VRAY_RENDER_ELEMENT_BASE, # for the common description
	ID_VRAY_RENDER_ELEMENT_ROOT, # for the render elements branch head
	ID_VRAY_RENDER_ELEMENT_FOLDER, # for RenderElementFolder
	ID_VRAY_RENDER_ELEMENT_COLOR, # for RenderElementColor
	ID_VRAY_RENDER_ELEMENT_COLOR_NO_DENOISE, # for RenderElementColorNoDenoise
	ID_VRAY_RENDER_ELEMENT_NORMALS, # for RenderElementNormals
	ID_VRAY_RENDER_ELEMENT_GLOSSINESS, # for RenderElementGlossiness
	ID_VRAY_RENDER_ELEMENT_ZDEPTH, # for RenderElementZDepth
	ID_VRAY_RENDER_ELEMENT_BUMP_NORMALS, # for RenderElementBumpNormals
	ID_VRAY_RENDER_ELEMENT_NODE_ID, # for RenderElementNodeID
	ID_VRAY_RENDER_ELEMENT_VELOCITY, # for RenderElementVelocity
	ID_VRAY_RENDER_ELEMENT_RENDER_ID, # for RenderElementRenderID
	ID_VRAY_RENDER_ELEMENT_COVERAGE, # for RenderElementCoverage
	ID_VRAY_RENDER_ELEMENT_LIGHT_SELECT, # for RenderElementLightSelect
	ID_VRAY_RENDER_ELEMENT_CRYPTOMATTE, # for RenderElementCryptomatte
	ID_VRAY_RENDER_ELEMENT_LIGHT_MIX, # for RenderElementLightMix
	ID_VRAY_RENDER_ELEMENT_EXTRA_TEX, # for RenderElementExtraTex
	ID_VRAY_RENDER_ELEMENT_COAT, # for RenderElementCoat
	ID_VRAY_RENDER_ELEMENT_COAT_REFLECTION, # for RenderElementCoatReflection
	ID_VRAY_RENDER_ELEMENT_SHEEN, # for RenderElementSheen
	ID_VRAY_RENDER_ELEMENT_SHEEN_REFLECTION, # for RenderElementSheenReflection
	ID_VRAY_RENDER_ELEMENT_OBJECT_SELECT, # for RenderElementObjectSelect
	ID_VRAY_RENDER_ELEMENT_MATERIAL_SELECT, # for RenderElementMaterialSelect
	ID_VRAY_RENDER_ELEMENT_MULTI_MATTE, # for RenderElementMultiMatte
	ID_VRAY_RENDER_ELEMENT_MULTI_MATTE_ID, # for RenderElementMultiMatteID
	ID_VRAY_RENDER_ELEMENT_TOON, # for RenderElementToon
	ID_VRAY_RENDER_ELEMENT_SAMPLER_INFO, # for RenderElementSamplerInfo
	ID_VRAY_RENDER_ELEMENT_DR_BUCKET # for RenderElementDRBucket
]

# these aovs sub type is equal to their id
VRAY_RNDER_ELEMENTS_CORE_IDS = [
    ID_VRAY_RENDER_ELEMENT_SAMPLER_INFO,
    ID_VRAY_RENDER_ELEMENT_LIGHT_MIX,
    ID_VRAY_RENDER_ELEMENT_COAT,
    ID_VRAY_RENDER_ELEMENT_COAT_REFLECTION,
    ID_VRAY_RENDER_ELEMENT_SHEEN,
    ID_VRAY_RENDER_ELEMENT_SHEEN_REFLECTION,
    ID_VRAY_RENDER_ELEMENT_FOLDER
]


VRAY_AOV_BACKGROUND = [1054151, 124, 'Background']
VRAY_AOV_LIGHTING = [1054151, 107, 'Lighting']
VRAY_AOV_GLOBAL_ILLUMINATION = [1054151, 108, 'Global Illumination']
VRAY_AOV_REFLECTION = [1054151, 102, 'Reflection']
VRAY_AOV_REFRACTION = [1054151, 103, 'Refraction']
VRAY_AOV_SPECULAR = [1054151, 106, 'Specular']
VRAY_AOV_SSS = [1054151, 133, 'SSS']
VRAY_AOV_DR_BUCKET = [1061337, 134, 'DR Bucket']
VRAY_AOV_RAW_SHEEN_REFLECTION = [1054151, 184, 'Raw Sheen Reflection']
VRAY_AOV_RAW_SHADOW = [1054151, 112, 'Raw Shadow']
VRAY_AOV_RAW_SHEEN_FILTER = [1054151, 183, 'Raw Sheen Filter']
VRAY_AOV_RAW_COAT_REFLECTION = [1054151, 190, 'Raw Coat Reflection']
VRAY_AOV_RAW_COAT_FILTER = [1054151, 189, 'Raw Coat Filter']
VRAY_AOV_RAW_REFRACTION = [1054151, 121, 'Raw Refraction']
VRAY_AOV_RAW_REFLECTION = [1054151, 119, 'Raw Reflection']
VRAY_AOV_RAW_TOTAL_LIGHT = [1054151, 130, 'Raw Total Light']
VRAY_AOV_RAW_GI = [1054151, 110, 'Raw GI']
VRAY_AOV_RAW_LIGHTING = [1054151, 111, 'Raw Lighting']
VRAY_AOV_SAMPLER_INFO = [1061231, 1061231, 'Sampler Info']
VRAY_AOV_COVERAGE = [1054160, 6001, 'Coverage']
VRAY_AOV_EXTRA_TEX = [1055728, 6007, 'Extra Tex']
VRAY_AOV_SAMPLE_RATE = [1054152, 132, 'Sample Rate']
VRAY_AOV_NORMALS = [1054153, 123, 'Normals']
VRAY_AOV_BUMP_NORMALS = [1054156, 131, 'Bump Normals']
VRAY_AOV_ZDEPTH = [1054155, 117, 'ZDepth']
VRAY_AOV_VELOCITY = [1054158, 113, 'Velocity']
VRAY_AOV_SELF_ILLUMINATION = [1054151, 104, 'Self-Illumination']
VRAY_AOV_CAUSTICS = [1054151, 109, 'Caustics']
VRAY_AOV_MATTE_SHADOW = [1054151, 128, 'Matte Shadow']
VRAY_AOV_CRYPTOMATTE = [1054317, 158, 'Cryptomatte']
VRAY_AOV_RENDER_ID = [1054159, 114, 'Render ID']
VRAY_AOV_OBJECT_SELECT = [1056127, 6006, 'Object Select']
VRAY_AOV_OBJECT_ID = [1054157, 116, 'Object ID']
VRAY_AOV_MULTI_MATTE_ID = [1056239, 6005, 'Multi Matte ID']
VRAY_AOV_MULTI_MATTE = [1056238, 6004, 'Multi Matte']
VRAY_AOV_MATERIAL_SELECT = [1060059, 6003, 'Material Select']
VRAY_AOV_MATERIAL_ID = [1054151, 115, 'Material ID']
VRAY_AOV_ATMOSPHERIC_EFFECTS = [1054151, 100, 'Atmospheric Effects']
VRAY_AOV_DIFFUSE = [1060059, 101, 'Diffuse']
VRAY_AOV_SHADOW = [1054151, 105, 'Shadow']
VRAY_AOV_TOTAL_LIGHT = [1054151, 129, 'Total Light']
VRAY_AOV_REFLECTION_FILTER = [1054151, 118, 'Reflection Filter']
VRAY_AOV_REFRACTION_FILTER = [1054151, 120, 'Refraction Filter']
VRAY_AOV_LIGHT_MIX = [1055656, 1055656, 'Light Mix']
VRAY_AOV_LIGHT_SELECT = [1054224, 163, 'Light Select']
VRAY_AOV_REFLECTION_IOR = [1054154, 140, 'Reflection IOR']
VRAY_AOV_REFLECTION_GLOSSINESS = [1054154, 135, 'Reflection Glossiness']
VRAY_AOV_REFRACTION_GLOSSINESS = [1054154, 137, 'Refraction Glossiness']
VRAY_AOV_REFLECTION_HIGHLIGHT_GLOSSINESS = [1054154, 136, 'Reflection Highlight Glossiness']
VRAY_AOV_METALNESS = [1054154, 165, 'Metalness']
VRAY_AOV_COAT = [1055759, 1055759, 'Coat']
VRAY_AOV_COAT_FILTER = [1054151, 191, 'Coat Filter']
VRAY_AOV_COAT_REFLECTION = [1055760, 1055760, 'Coat Reflection']
VRAY_AOV_COAT_GLOSSINESS = [1054154, 192, 'Coat Glossiness']
VRAY_AOV_SHEEN = [1055761, 1055761, 'Sheen']
VRAY_AOV_SHEEN_FILTER = [1054151, 185, 'Sheen Filter']
VRAY_AOV_SHEEN_REFLECTION = [1055762, 1055762, 'Sheen Reflection']
VRAY_AOV_SHEEN_GLOSSINESS = [1054154, 186, 'Sheen Glossiness']
VRAY_AOV_TOON = [1060306, 154, 'Toon']
VRAY_AOV_TOON_LIGHTING = [1054151, 180, 'Toon Lighting']
VRAY_AOV_TOON_SPECULAR = [1054151, 181, 'Toon Specular']